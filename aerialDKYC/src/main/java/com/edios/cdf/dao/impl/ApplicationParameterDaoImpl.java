...
public class ApplicationParameterDaoImpl extends BaseDaoImpl<ApplicationParameterEntity>
	...
	public boolean getAppParameterNameExists(String parameterName) {
		try {
			...
			list = session.createQuery(
					"select table.parameterName from ApplicationParameterEntity table where table.parameterName=:parameterName and table.recordType<>'D'")
	...
	public boolean getAppParameterCodeExists(String parameterCode) {
		try {
			...
			Session session = (Session) entityManager.getDelegate();
			list = session.createQuery(
					"select table.parameterName from ApplicationParameterEntity table where table.parameterCode=:parameterCode and table.recordType<>'D'")
	...
	public boolean getAppParameterNameExists(String parameterName, Long parameterID) {
		try {
			...
			Session session = (Session) entityManager.getDelegate();
			list = session.createQuery(
					"select table.parameterName from ApplicationParameterEntity table where table.parameterName=:parameterName and table.parameterID!=:parameterID and table.recordType<>'D'")
	...
	public boolean isAppParameterCodeExists(String parameterCode, Long parameterID) {
		try {
			...
			Session session = (Session) entityManager.getDelegate();
			list = session.createQuery(
					"select table.parameterName from ApplicationParameterEntity table where table.parameterCode=:parameterCode and table.parameterID!=:parameterID and table.recordType<>'D'")
